...
The backend is deployed on Microsoft Azure App Service (Linux).
FastAPI is served using Gunicorn with Uvicorn workers.
...
3.Hand landmarks are extracted and normalized
4.The gesture is matched against known signs using similarity search
5.The recognized sign is returned in real time
